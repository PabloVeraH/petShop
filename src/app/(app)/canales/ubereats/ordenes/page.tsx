...
export default function UberEatsOrdenesPage() {
  ...
  const fetchOrdenes = useCallback(async () => {
    try {
      const res = await fetch("/api/canales/orders?canal=ubereats");
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-800">Órdenes Uber Eats</h1>
