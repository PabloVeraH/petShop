  ...
  async function handleSync() {
    ...
    try {
      const res = await fetch("/api/canales/catalog", {
        ...
        body: JSON.stringify({ canal_id: "pedidosya" }),
      });
    ...
    <div className="max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">Catálogo PedidosYa</h1>
        ...
        <button
          ...
          className="px-4 py-2 bg-yellow-500 text-white text-sm font-medium rounded-md hover:bg-yellow-600 disabled:opacity-50"
        >
