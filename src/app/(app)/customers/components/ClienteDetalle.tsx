    ...
    <div className="space-y-5">
      ...
      {data.saldo_disponible > 0 && (
        <div className="rounded-lg bg-amber-50 border border-amber-100 px-4 py-3">
          <p className="text-xs font-semibold text-amber-700 mb-1">Saldo a favor</p>
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold text-amber-800">
              ${Math.round(Number(data.saldo_disponible)).toLocaleString("es-CL")} disponible
            </p>
            <p className="text-xs text-amber-600">Aplicable en próxima compra</p>
          </div>
        </div>
      )}
