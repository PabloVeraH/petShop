...
--
-- Esta migración es idempotente (los WHERE estado='activa' hacen que
-- reejecutarla sea un no-op si ya se aplicó) y sirve como registro
-- versionado de la reparación ya ejecutada vía SQL directo.
